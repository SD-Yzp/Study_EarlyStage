...
import cn.sd.yz.sorm.po.T_emp;
import cn.sd.yz.sorm.utils.JDBCUtils;
import cn.sd.yz.sorm.utils.ReflectUtils;
import cn.sd.yz.sorm.vo.EmpVO;
...
public class MySqlQuery implements Query 
{
	...
	{
		List<T_emp> list = new MySqlQuery().
		queryRows("select id,empname,age from emp where age>? and salary<?",
				T_emp.class, new Object[]{10,5000});
...
//			Number obj = (Number)new MySqlQuery().queryValue("select count(*) from emp where salary>?",new Object[]{1000});
			Number obj = new MySqlQuery().
					queryNumber("select count(*) from emp where salary>?",new Object[]{1000});
	...
	public void delete(Class clazz, Object id) 
	{
		...
		String sql = "delete form "+tableInfo.getTname()+" where "+onlyPriKey.getName()+"=? ";
	...
	public Number queryNumber(String sql, Object[] params) {
		...
		return (Number)queryNumber(sql, params);
	}
